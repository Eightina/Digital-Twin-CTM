...
sumo_delay, time0 = ac_p80(
    ...
    # sumo_df.insert()
sumo_df["{}".format('fixed')] = list(sumo_delay)
# ctm_df["{}".format(max_iter)] = list(og_ctm_delay)
time_df["{}".format('fixed')] = list(time0)
sumo_df.to_csv("./Output/experiments/8/0/sumo.csv")
# ctm_df.to_csv("./Output/experiments/7/x/ctm.csv")
time_df.to_csv("./Output/experiments/8/0/time.csv")
