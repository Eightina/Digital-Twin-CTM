...
for max_iter in [50, 100, 150, 200, 250, 300, 400, 500]:
    sumo_delay, og_ctm_delay, time0 = ac_p7x(
        cell_scale=2,
    ...
    # sumo_df.insert()
    sumo_df["{}".format(max_iter)] = list(sumo_delay)
    ctm_df["{}".format(max_iter)] = list(og_ctm_delay)
    time_df["{}".format(max_iter)] = list(time0)
sumo_df.to_csv("./Output/experiments/7/x/sumo.csv")
ctm_df.to_csv("./Output/experiments/7/x/ctm.csv")
time_df.to_csv("./Output/experiments/7/x/time.csv")
