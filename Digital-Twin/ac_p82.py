...
sumo_delay, og_ctm_delay, time0 = ac_p82(
    ...
    # sumo_df.insert()
sumo_df["{}".format('dt_grid')] = list(sumo_delay)
ctm_df["{}".format('dt_grid')] = list(og_ctm_delay)
time_df["{}".format('dt_grid')] = list(time0)
sumo_df.to_csv("./Output/experiments/8/2/sumo.csv")
ctm_df.to_csv("./Output/experiments/8/2/ctm.csv")
time_df.to_csv("./Output/experiments/8/2/time.csv")
