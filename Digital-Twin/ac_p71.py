...
for scale in [1, 2, 3, 4]:
    sumo_delay, og_ctm_delay, time0 = ac_p71(
        cell_scale=scale,
...
sumo_df.to_csv("./Output/experiments/7/1/sumo.csv")
ctm_df.to_csv("./Output/experiments/7/1/ctm.csv")
time_df.to_csv("./Output/experiments/7/1/time.csv")
