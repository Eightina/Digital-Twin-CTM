...
for scale in [1, 2, 3, 4]:
    sumo_delay, og_ctm_delay, time0 = ac_p70(
        cell_scale=scale,
...
sumo_df.to_csv("./Output/experiments/7/0/sumo.csv")
ctm_df.to_csv("./Output/experiments/7/0/ctm.csv")
time_df.to_csv("./Output/experiments/7/0/time.csv")
