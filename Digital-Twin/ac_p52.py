...
for seconds in [0, 5, 10, 15, 20, 30, 40, 50]:
    sumo_delay, og_ctm_delay, time0 = ac_p52(
...
sumo_df.to_csv("./Output/experiments/5/pred/sumo.csv", index=False)
ctm_df.to_csv("./Output/experiments/5/pred/ctm.csv", index=False)
time_df.to_csv("./Output/experiments/5/pred/time.csv", index=False)