...
sumo_delay, og_ctm_delay, time0 = ac_p83(
    cell_scale=2,
    ...
    # sumo_df.insert()
sumo_df["{}".format('bayes&pred')] = list(sumo_delay)
ctm_df["{}".format('bayes&pred')] = list(og_ctm_delay)
time_df["{}".format('bayes&pred')] = list(time0)
sumo_df.to_csv("./Output/experiments/8/3/sumo.csv")
ctm_df.to_csv("./Output/experiments/8/3/ctm.csv")
time_df.to_csv("./Output/experiments/8/3/time.csv")
