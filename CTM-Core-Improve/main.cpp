...
void print_start(){
	...
	printf("\n");
	printf(" Green Signal is a signalized intersection timing optimization tool \n");
	printf(" embbed cell-transmission model and solved by A* search algorithm.\n");
	printf(" Green Signal is free software. You can redistribute it or modify it\n");
...
/*
 ...
 Green Signal is a signalized intersection timing optimization tool
 embbed cell-transmission model and solved by A* search algorithm.
 Green Signal is free software. You can redistribute it or modify it
 under the terms of the GNU General Public License 3.0.

 Development Team: Zhang Kai, Wang Yi, Xiong Yiliang.
 Institution: Southwest Jiaotong University.
 Last Update: April 2008.


 ******* Green Signal is running now. *******
...
RESULTS
  ...
  Iterative #1
  Intersection #1, total delay = 139663.61
  Intersection #2, total delay = 125335.61

  Iterative #2
  Intersection #1, total delay = 122370.15
  Intersection #2, total delay = 121804.88

  Iterative #3
  Intersection #1, total delay = 119453.40
  Intersection #2, total delay = 119179.18

  Iterative #4
  Intersection #1, total delay = 119179.17
  Intersection #2, total delay = 119179.18

Total delay (before optimization): 145957.06 veh*sec.
Total delay (after network optimization): 119179.18 veh*sec.
Total delay (simulate best timing plan): 119179.20 veh*sec.
Running time: 11.172 seconds.

Timing plan output files
 >>t_Test2.txt
Cell occupation output files
 >>o_Test2.txt
Detail delay output files
 >>d_Test2.txt
